/*** Generated by streamline 0.4.11 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename),__func=__rt.__func,__cb=__rt.__cb,__tryCatch=__rt.__tryCatch; (function() {
  ...
  module.exports = Relationship = (function(_super) {
    ...
    Relationship.prototype.save = function Relationship_prototype_save__1(_) { var response, __this = this; var __frame = { name: "Relationship_prototype_save__1", line: 81 }; return __func(_, this, arguments, Relationship_prototype_save__1, 0, __frame, function __$Relationship_prototype_save__1() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$Relationship_prototype_save__1() {
              ...
              return __this._request.put({
                ...
                if ((response.statusCode !== status.NO_CONTENT)) {
                  ...
                  case status.NOT_FOUND:
                    ...
                    return _(response);
                  }; } ; return _(null, __this); }, true)); }); })(function ___(error, __result) { __tryCatch(_, function __$Relationship_prototype_save__1() { if (error) {
